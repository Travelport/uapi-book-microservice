...
public class FormOfPaymentIdentifier {
     ...
     * 
     */
    public FormOfPaymentIdentifier() {
    }
     ...
     * @param identifier
     */
    public FormOfPaymentIdentifier(String id, String formOfPaymentRef, Identifier identifier) {
        super();
        this.id = id;
