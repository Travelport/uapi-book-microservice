...
@JsonPropertyOrder({"@type", "encryptionKey", "encryptionKeyMethod", "encryptionMethod",
    "encryptedValue", "mask", "token", "tokenProviderID", "authenticationMethod", "PlainText",
    "ErrorWarning"})
public class SeriesCode {
   ...
   * @param plainText
   */
  public SeriesCode(String type, String encryptionKey, String encryptionKeyMethod,
      String encryptionMethod, String encryptedValue, String mask, String token,
      String tokenProviderID, String authenticationMethod, String plainText,
