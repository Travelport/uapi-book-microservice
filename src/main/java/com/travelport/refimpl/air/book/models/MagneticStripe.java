...
public class MagneticStripe {
     ...
     * @param plainText
     */
    public MagneticStripe(String type, String encryptionKey, String encryptionKeyMethod, String encryptionMethod, String encryptedValue, String mask, String token, String tokenProviderID, String authenticationMethod, String plainText, ErrorWarning errorWarning) {
        super();
        this.type = type;
